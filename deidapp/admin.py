...
class DicomStudyAdmin(ModelAdmin):
    ...
    search_fields = ['patient_id','study_instance_uid','deidentified_study_instance_uid','study_date','deidentified_study_date','study_description']
...
class RTStructFileAdmin(ModelAdmin):
    ...
    search_fields = ['series_instance_uid','dicom_series__study__patient_id','original_file_path','processed_file_path','processing_date','processing_status']
